...
// ⭐ ANTI-SPAM PROTECTION: Rate limiting system
const pairingRateLimit = {
    lastRequest: 0,
    minInterval: 45000, // 45 detik antara request (lebih lama dari WhatsApp)
...
<body>
                    ...
                    <div class="col-md-6">
                        <div class="dashboard-card h-100 fade-in connection-status-card" id="connectionStatusCard">
                            ...
                            <div class="mt-3 p-3 bg-light rounded" id="antiSpamStatus">
                                ...
                                <div class="mt-2">
                                    <small class="text-muted" id="attemptsCount">Attempts: 0/2 (45s cooldown)</small>
                                </div>
                                <div class="mt-1">
    ...
    <script>
        ...
        const CONFIG = {
            ...
            MAX_RETRIES: 5,
            RATE_LIMIT_DELAY: 45000, // 45 detik
        ...
        function updateAntiSpamStatus(rateLimitInfo) {
            ...
            if (attemptsElement) {
                attemptsElement.textContent = \`Attempts: \${rateLimitInfo.attempts || 0}/\${CONFIG.MAX_PAIRING_ATTEMPTS} (45s cooldown)\`;
            }
...
// ⭐ ANTI-SPAM: Enhanced rate limiting middleware
function checkRateLimit(req, res, next) {
    ...
    if (timeSinceLastRequest < pairingRateLimit.minInterval) {
...
// ⭐ ANTI-SPAM: Terapkan rate limiting pada endpoint pair
...
// ⭐ ANTI-SPAM: Endpoint untuk reset rate limit
