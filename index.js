...
// ⭐⭐ PERBAIKAN: Konfigurasi delay yang lebih optimal
...
// ⭐⭐ PERBAIKAN: Phone number functions yang lebih responsif
...
async function startNazeBot() {
    ...
    // ⭐⭐ PERBAIKAN BESAR: Handle pairing code dengan protection multiple requests
    if (pairingCode && !naze.authState.creds.registered && !pairingCodeGenerated) {
        ...
        if (phoneNumberToUse) {
            ...
            try {
                ...
                // ⭐⭐ PERBAIKAN: Set timeout untuk reset pairing code setelah 25 detik
                setTimeout(() => {
                ...
                }, 25000); // 25 detik (5 detik lebih lama dari masa aktif WhatsApp)
