...
const DELAY_BEFORE_PAIRING = 3000;     // 3 detik sebelum mulai pairing
...
// Phone number functions - Diperbaiki untuk Koyeb
...
async function startNazeBot() {
    ...
    if (pairingCode && !naze.authState.creds.registered) {
        ...
        try {
            ...
            phoneNumberToUse = await waitForPhoneFromWebDashboard(180000); // 3 menit timeout untuk web
